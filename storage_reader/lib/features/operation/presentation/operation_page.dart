              ...
              child: BlocConsumer<GetOperationCubit, GetOperationState>(
                ...
                if (state is GotOperationState) {
                  ...
                  return Column(
                    ...
                    children: [
                      TitleDivider("${operation.type.capitalize()} Operation"),
                      const SizedBox(
                        height: 20,
                      ),
                      Row(
                ...
                return SizedBox(
                    ...
                    child: const Center(
                      child:
                          ErrorOccurredTextWidget(errorType: ErrorType.server),
                    ));
              }),
            ),
          ],
            ...
            TableRow(
              children: [
                ...
                TableCell(
                  ...
                  padding: const EdgeInsets.fromLTRB(0, 10, 0, 10),
                  child: Text(
                      operation.getLastFromReadings(isTemp: false).toString()),
                )),
                TableCell(
                  child: Padding(
                    padding: const EdgeInsets.fromLTRB(0, 10, 0, 10),
                    child: Text(
                        operation.getAvgFromReadings(isTemp: false).toString()),
                  ),
                ),
              ],
            ),
